...
2. Make sure the user 'temp' is created with port 'localhost' along with an empty database called UNIVERSITY in your SQL server before running these commands.
2. Loading: <code>mysql -u <em>temp</em> data.sql</code>
